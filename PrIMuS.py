...
def main(): 
    ...
    parse.add_argument("--is-sweep", action="store_true", default=False)
    ...
    if not args.is_sweep and not args.checkpoint_path:
    ...
    wandb.init(name=args.save_path, project="PrIMuS", config=config, id=)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # every save_interval (10) save model & loss smaller than previous test_loss
